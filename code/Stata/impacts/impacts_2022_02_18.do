...
global Dtabs "/Users/dylanglover/Dropbox (Personal)/Apps/Overleaf/Land Inequality from the Sky/figures"
global rep "$DG"
cd "$DG"
...
binscatter month_gpp mean_temp
...
* All
eststo hot: reghdfe month_gpp t_q_1 t_q_2 t_q_3 t_q_4 t_q_5 q_1 q_2 q_3 q_4 , absorb(canton i.year##i.month) vce(cl canton)
...
gen P_A=avg_hold_peri/avg_hold_ha 
lab var P_A "Perimeter-Area ratio"

global xvars "mean_temp_farms mean_temp month_gpp_farms month_gpp herfindahl n_holdings P_A avg_hold_ha avg_hold_peri area_agri area_1_pct-area_99_pct area_10_pct dn_ecob*"
eststo clear
...
cap drop PtoA
gen PtoA= (avg_hold_peri) /avg_hold_ha*10000
cap drop lPtoA
gen lPtoA=ln(PtoA)
