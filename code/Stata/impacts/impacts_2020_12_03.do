...
reghdfe month_gpp hot##gini_q if area_agri>20,  absorb(canton year month) vce(cl canton)

binscatter month_gpp_farms mean_temp_farms if hot==1, by(gini_q)


 did_multiplegt month_gpp canton year hot, placebo(3) breps(10) cluster(canton) dynamic(2) robust_dynamic 
